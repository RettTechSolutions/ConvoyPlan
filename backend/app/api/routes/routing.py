...
_MAX_IMPORT_BYTES = 10 * 1024 * 1024  # 10 MiB — prevents memory-DoS via huge uploads


def _safe_filename(name: str) -> str:
    """Strip characters that could break Content-Disposition header (CWE-113)."""
    return re.sub(r'[^\w\s\-.]', '_', name)[:100]
