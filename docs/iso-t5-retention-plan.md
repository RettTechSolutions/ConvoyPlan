...
> Status: **Umgesetzt** (Phasen 1–4). Defaults bestätigt: Positionen 24 h, Audit 365 Tage, Share-Links 30 Tage; Auslösung per Cron-Container; Audit-Pseudonymisierung bei Löschung; Admin-UI-Buttons (Export/Löschen) im Benutzer-Modal. Offen: org-spezifische Fristen.
